        ...
        <div className="glass p-8 rounded-lg max-w-md mx-auto">
          ...
          <div className="flex justify-center">
            <ButtonColorful 
              ...
              className="px-8 py-3"
              onClick={() => window.open("https://wa.me/5511974232091?text=Ol%C3%A1%2C%20vim%20pelo%20o%20seu%20site%2C%20gostaria%20de%20saber%20mais%20sobre%20o%20seu%20Tr%C3%A1fego%20pago.", '_blank')}
            />
          </div>
        </div>
      </div>
